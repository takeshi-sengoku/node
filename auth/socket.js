...
var socketPath = require('../config/socketPath.json');
var nodeName = 'auth';
...
swaggerTools.initializeMiddleware(swaggerDoc, function (middleware) {
  ...
  fs.unlink(socketPath[nodeName]);
  app.listen(socketPath[nodeName], function(err) {
    if (err) throw err;
    fs.chmodSync(socketPath.spring, '660');
